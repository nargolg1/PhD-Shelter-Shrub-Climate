...
animal_species_spring<-animal_species_compiled%>%filter(season =="spring")###Run a PCOA for spring only 
...
ggmap(california) +
  geom_jitter(data= lat_long, aes(x=long, y=lat, color = site_code, shape = site_code), size =6, show.legend = TRUE) +
