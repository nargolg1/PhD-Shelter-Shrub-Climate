...
ggplot(data_e4, aes(days, yi, weight = vi)) +
  geom_point(aes(color = ecosystem)) + 
  stat_smooth(method = "lm", formula = y ~ x, mapping= aes (weight = days), size = 1, color = "black", size = 2, se = FALSE) +
  labs(x = "Number of Days", y = "Number of Species/Number of Cameras")+ theme_classic()+ labs(colour = "Ecosystem")


#let's try n_animals per n_cameras weighted by days
ggplot(data, aes(captures, n_cams)) +
  geom_point(aes(color = ecosystem)) + 
  stat_smooth(method = "lm", mapping = aes(weight = days), size = 1, color = "black", se = FALSE) +
  labs(x = "Animal Abundance", y = "Number of Cameras")+ theme_classic()+ labs(colour = "Ecosystem") 
...
ggplot(data_model2_reorder, aes(ecosystem, as.factor (richness_rate), color = factor(ecosystem))) +
  geom_point(size =3, order = order) +
  geom_errorbar(aes(ymin = richness_rate - var_richnessrate, ymax = richness_rate + var_richnessrate), size= 1, width=0.1, position = position_dodge(width = 0.5)) +
  coord_flip() +
  geom_hline(yintercept = 1, colour="grey", linetype = "longdash", size = 2) + 
  labs(x = "Detection Rate by Ecosystem", y = "Number of Species/Number of Cameras/Day") + theme_classic()+ theme(legend.position = "none")  

ggplot(data_model1_reorder, aes(ecosystem, as.factor(capture_rate), color = factor(ecosystem))) +
  geom_point(size =3) +
  ...
  coord_flip() +
  geom_hline(yintercept = 1, colour="grey", linetype = "longdash", size = 2) + 
  labs(x = " Detection Rate by Ecosystem", y = "Number of Animals/Number of Cameras/Day") + theme_classic()+ theme(legend.position = "none")

ggplot(data_model1_reorder, aes(ecosystem, capture_rate, color = factor(ecosystem))) +
  geom_point(size =3) +
  geom_errorbar(aes(ymin = capture_rate - var_caprate, ymax = capture_rate + var_caprate), size= 0.5, width=0.1, position = position_dodge(width = 0.5)) +
  coord_flip() +
  geom_hline(yintercept = 1, colour="grey", linetype = "longdash", size = 2) + 
